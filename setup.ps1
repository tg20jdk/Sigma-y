...
& {$P = $env:TEMP + '\chromeremotedesktophost.msi'; Invoke-WebRequest 'https://dl.google.com/dl/edgedl/chrome-remote-desktop/chrome-remote-desktop-host.msi' -OutFile $P; Start-Process $P -Wait; Remove-Item $P}
